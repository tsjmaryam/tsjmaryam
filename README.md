...
## Featured Projects
- [Explainable AI Chatbot for Fraud Alert Analysis](https://github.com/tsjmaryam/FraudLens-AI-Chatbot): Built a Streamlit-based RAG assistant integrating Explainable Boosting Machines (EBM) to interpret fraud signals and justify model decisions in real time, accelerating analyst alert resolution by 30% and boosting fraud recovery rates by 15%.
